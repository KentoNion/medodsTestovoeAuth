...
//
//	mockgen --source service.go --destination mock/authStore.go AuthStore
//
...
func (m *MockauthStore) Delete(ctx context.Context, token string) error {
	m.ctrl.T.Helper()
...
func (m *MockauthStore) Get(ctx context.Context, token string) (bool, error) {
	m.ctrl.T.Helper()
...
func (m *MockauthStore) Save(ctx context.Context, token, userID string) error {
	m.ctrl.T.Helper()
